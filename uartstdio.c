...
//*****************************************************************************
 ...
 volatile uint32_t g_ui32UARTTxWriteIndex = 0;
 volatile uint32_t g_ui32UARTTxReadIndex = 0;
...
//*****************************************************************************
 ...
 volatile uint32_t g_ui32UARTRxWriteIndex = 0;
 volatile uint32_t g_ui32UARTRxReadIndex = 0;
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTBase[7] =
{
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTInt[7] =
{
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTPeriph[7] =
{
...
int
UARTwrite3(const char *pcBuf, uint32_t ui32Len)
{
#ifdef UART_BUFFERED
    unsigned int uIdx;
...
void Flush_UARTRxBufferArray(void )
{
	uint32_t ui32ReadIndex = 0,ui32WriteIndex = 0;
	
	for(ui32WriteIndex = 0;ui32WriteIndex<g_ui32UARTRxWriteIndex;ui32WriteIndex++ )	
	{
		g_pcUARTRxBuffer[ui32WriteIndex] = 0;
	}
