...
#define PUC										0x09   //Preuse check
#define PCT										0x0A	 //Patient circuit test
...
typedef struct _VentAlgParame
{
	...
	uint32_t ulInspZeroValve;
	uint32_t ulAuxValve;
	uint32_t ulInsEffortValve;	
}VentAlgParameters;
...
extern void preusecheck(void);
extern void patient_ckt_chk(void);
