...
void DIO_Init()
{
  ...
  HWREG(GPIO_PORTF_BASE + GPIO_O_CR) = GPIO_PIN_0;
	...
	ROM_GPIODirModeSet(GPIO_PORTF_BASE,GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5, GPIO_DIR_MODE_IN);           
  ROM_GPIOPadConfigSet(GPIO_PORTF_BASE, GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPD);
...
//	}
	...
	if(medProc_Flag ==1)//counter for medical procedure
	{
		medProcCounter++;
	}
}